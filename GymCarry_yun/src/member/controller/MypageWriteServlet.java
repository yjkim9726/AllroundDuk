...
/**
 * Servlet implementation class MypageWriteServlet
 */
@WebServlet("/mypage/writeList")
public class MypageWriteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MPageData pageData = new MarketService().printIdMarketList(currentPage,uniqId); 
...
//			view.forward(request, response);
		...
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/mypage/mypageWrite.jsp");
		view.forward(request, response);
	}
