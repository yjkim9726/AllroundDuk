...
<link
	...
	rel="stylesheet">
<link rel="stylesheet" type="text/css" href="/resources/css/messageDetail.css">
<style>
</style>
</head>
<body>
	...
	<div class="dialog">
		...
		<div id="msg-list" class="msg-list">
			<div class="top-box">
				...
				<div id="msg-read" class="msg-top">
					<input type="hidden" value="<%=message.getReadCount()%>" name="readCount">
				</div>
		...
		<div class="btn" id="re-btn">
			<%-- <form action="/message/delete?messageNo=<%= message.getMessageNo() %>" method="post"> --%>
			...
			<a href="/message/reply?messageNo=<%=message.getMessageNo()%>">
				<input type="submit" value="답장" class="reply-btn">
			</a>
			<!-- </form> -->
		</div>
	</div>
