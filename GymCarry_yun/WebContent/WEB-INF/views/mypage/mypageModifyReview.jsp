...
<html>
    ...
    <div class="frame">
        ...
        <form id="reviewUploadForm" action="/review/modify" method="post" enctype="multipart/form-data">
       	<input type="hidden" value="<%= review.getRvNo() %>" name="reviewNo">
        <input type="hidden" id="rvRecommend" name="rvRecommend">
        <input type="hidden" name="partnerCode" value="<%= review.getPartnerCode() %>"> 
        <div class="content">
            <div class="title">
                <div id="name"><span name="partner-name"><%= review.getPartnerName() %></span></div>
            ...
            <div id="write_box">
                <textarea id="rev_write" name="rev_write" maxlength="400" cols="90" rows="12" placeholder="내용을 입력해주세요(400자 이내). "><%= review.getRvContent() %></textarea><br>
        ...
        <div class="btns">
            ...
            <input type="button" value="리뷰 수정" id="upload-btn" onclick="cnfReviewUpload()">
        </div>
