...
/*           	$('.sub').on("click", function(){
    ...
    <div id="wrapper">
        ...
        <main>
            <div class="frame">
                <form action="/market/modify" method="POST" name="marketwriteForm" enctype="multipart/form-data">
                   	<input type="hidden" value="<%= market.getMarketNo() %>" name="marketNo">
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="textbox title" name="title" placeholder=" 제목을 입력하세요." value="<%= market.getMarketTitle() %>" required></td>
                        </tr>
                        <tr>
                            <td class="tabletext">운동종목</td>
                            <td> 
                            	<% if(market.getMarketField().equals("필라테스")) { %>
				        		...
				        		<% } else if(market.getMarketField().equals("헬스")){ %>
				        		<input type="radio" name="field" class="field" value="필라테스"><label for="f" >필라테스</label> <input type="radio" name="field"class="field" value="헬스" checked><label for="h">헬스</label> <input type="radio" name="field" class="field" value="기타" ><label for="o"> 기타</label>
				        		<% } else { %>
				        	    <input type="radio" name="field" class="field" value="필라테스"><label for="f" >필라테스</label> <input type="radio" name="field"class="field" value="헬스" ><label for="h">헬스</label> <input type="radio" name="field" class="field" value="기타" checked><label for="o"> 기타</label>
				        		<% } %>
				        	</td>
                        </tr>
                        <tr>
                            <td class="tabletext">희망가격</td>
                            <td><input type="text" class="textbox price" name="price" placeholder=" 가격을 입력하세요."  value="<%= market.getMarketPrice() %>" required></td>
                        </tr>
                        <tr>
                            <td class="tabletext">내용</td>
                            <td><textarea id="summernote" class="content" name="editordata" required><%=market.getMarketContent() %></textarea></td>
                        </tr>
                         <tr>
                        ...
                        <tr>
                            <td colspan="2" class="table-go" ><input type="submit" class="buttoms sub" name=submit value="수정하기"> 
                            <input type="reset" class="buttoms"name=reset value="취소"></td>  
                        </tr>
                    </table>
            </form>
        </div>
