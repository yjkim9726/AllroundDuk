...
<html>
    <head>
        <meta charset="utf-8">
        <title>짐캐리 소개</title>
        <link rel="stylesheet" type="text/css" href="/resources/css/adminMarketList.css">
            ...
            <div class="frame">
                <div class="topbox">
                    <div id="btnbox">
                        ...
                        <a href="#"><button class="pick">짐마켓관리</button></a>
                        <a href="/admin/eventlist"><button>근딜관리</button></a>
                    </div>
                    <div id="srchbox">
	                    <form action="/admin/marketsearch" method="get">
                ...
                <div id="conbox">
					...
					<tr>
                        ...
                        <!-- ++++++++++++++++++++삭제++++++++++++++++++++++++ -->
                        <td class="deletetd">
	                        <form action="/admin/marketdelete" method="get">
