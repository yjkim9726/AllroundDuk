...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/css/adminPartnerModify.css">
</head>
<body>
	<header>
	    <div class="frame">
...
<main>
	    <div class="frame">
	        <div class="inner-frame">
                ...
                <div class="contents">
                    <form action="/admin/partnermodify" method="post" enctype="multipart/form-data">
                    <div id="topcon">
                    	<input type="hidden" name="code" value="<%=partner.getPartnerCode()%>">
                        <span class="sub-title">운동 종류</span>
                        <div class="radio-box">
                       		<% if(partner.getPartnerType().equals("헬스")) { %>
	                        	<label class="box-radio-input">
                                <input type="radio" name="partnerType" value="헬스" checked="checked"><span>헬스</span>
                            	</label>
                            	<label class="box-radio-input">
                                <input type="radio" name="partnerType" value="요가">
                                <span>요가</span>
                            	</label>
                           		<label class="box-radio-input">
                                <input type="radio" name="partnerType" value="필라테스">
                                <span>필라테스</span>
                            	</label>
                            	<label class="box-radio-input last-radio">
                                <input type="radio" name="partnerType" value="기타">
                                <span>기타</span>
                            </label>
                            <input type="text" name="category" class="text-box short-box" placeholder="운동종류 입력">
				        	<% } else if(partner.getPartnerType().equals("요가")){ %>
				        		<label class="box-radio-input">
                                <input type="radio" name="partnerType" value="헬스"><span>헬스</span>
                            	</label>
                            	<label class="box-radio-input">
                                <input type="radio" name="partnerType" value="요가" checked="checked">
                                <span>요가</span>
                            	</label>
                           		<label class="box-radio-input">
                                <input type="radio" name="partnerType" value="필라테스">
                            	...
                            	<input type="text" name="partnerType" class="text-box short-box" placeholder="운동종류 입력">
				        	<% } else if(partner.getPartnerType().equals("필라테스")){ %>
				        		<label class="box-radio-input">
                                <input type="radio" name="partnerType" value="헬스"><span>헬스</span>
                            	</label>
                            	<label class="box-radio-input">
                                ...
                                <span>요가</span>
                           		...
                           		<label class="box-radio-input">
                                <input type="radio" name="partnerType" value="필라테스" checked="checked">
                                <span>필라테스</span>
                            	</label>
                            	<label class="box-radio-input last-radio">
                                <input type="radio" name="partnerType" value="기타">
				        	...
				        	<% }else {%>
                            	...
                            	<label class="box-radio-input last-radio">
                                <input type="radio" name="partnerType" value="기타" checked="checked">
                                <span>기타</span>
                            	</label>
                            	<input type="text" name="partnerType" class="text-box short-box" placeholder="운동종류 입력" value="<%=partner.getPartnerType()%>">
				        	<% } %>
                        </div>
                        <br>
                        <span class="sub-title">업체 명</span>
                        <input class="text-box" type="text" placeholder="업체명을 입력하세요" maxlength="14" name="partnerName" value="<%= partner.getPartnerName() %>"><br>
                        <span class="sub-title">주소</span>
                        <input class="text-box" type="text" placeholder="주소를 입력하세요" name="partnerAddress" value="<%= partner.getPartnerAddress() %>"><br>
                        <span class="sub-title">가격대</span>
                        <input class="text-box" type="text" placeholder="가격대를 입력하세요" name="partnerPrice" value="<%= partner.getPartnerPrice() %>"><br>
                        ...
                        <input class="text-box" type="text" placeholder="영업시간을 입력하세요" name="partnerHours" value="<%= partner.getPartnerHours() %>"><br>
                        <span class="sub-title">주차 여부</span>
                        <div class="radio-box">
                        	<% if(partner.getPartnerParking().equals("주차 가능")) { %>
	                            <label class="box-radio-input">
	                                <input type="radio" name="partnerParking" value="y" checked="checked">
	                                <span>주차 가능</span>
	                            </label>
	                            <label class="box-radio-input">
	                                <input type="radio" name="partnerParking" value="n">
	                                <span>주차 불가능</span>
	                            </label>
	                        <% }else{ %>
	                        	<label class="box-radio-input">
	                                <input type="radio" name="partnerParking" value="y">
	                                <span>주차 가능</span>
	                            </label>
	                            <label class="box-radio-input">
	                                <input type="radio" name="partnerParking" value="n"  checked="checked">
	                                <span>주차 불가능</span>
	                            </label>
	                        <% } %>
                        </div>
                        ...
                        <input class="text-box" type="text" placeholder="연락처를 입력하세요" name="partnerPhone" value="<%= partner.getPartnerPhone() %>"><br>
                    </div>
                        <span class="contitle">추가 내용</span>
                        <textarea id="summernote" name="addContent"><%= partner.getAddContent() %></textarea>
                        ...
                        <div id="teacher">
                            <div class="teacher1">
                            	<input type="hidden" name="tchrNo" value="<%=teacher.getTchrNo() %>">
                                <span class="teacher-title">강사명</span>
                                <input class="text-box" type="text" placeholder="강사명을 입력하세요" name="tchName" value="<%= teacher.getTchName() %>"><br>
                                <span class="teacher-title">과목명</span>
                                <input class="text-box" type="text" placeholder="과목명을 입력하세요" name="tchrClass" value="<%= teacher.getTchClass() %>"><br>
                                <span class="teacher-title">강사소개</span>
                                <input class="text-box" type="text" placeholder="강사소개를 입력하세요" name="tchrCareer" value="<%= teacher.getTchrCareer() %>"><br>
...
<!--                         <div class="teacherList"></div>
                        <div class="tchbtn-box">
                            <button class="tchbtn" id="plus" onclick="add_div()">추가</button>
                            <button class="tchbtn" onclick="remove_div(this)">삭제</button>    
                        </div> -->
                        <button class="smitbt" type="submit">수정</button>
                    </form>
                </div>
	        </div>
	    </div>
