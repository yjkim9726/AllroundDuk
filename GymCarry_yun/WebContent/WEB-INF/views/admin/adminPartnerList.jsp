            ...
            <div class="frame">
                ...
                <div id="conbox">
					...
					<tr>
                        ...
                        <td><a href="/partner/detail?code=<%= partner.getPartnerCode() %>"><%= partner.getPartnerType() %></td>
                        <td><a href="/partner/detail?code=<%= partner.getPartnerCode() %>"><%= partner.getPartnerName() %></a></td>
                        <td>
                        	<form action="/admin/partnerreview" method="get">
	                        	<button type="submit" id="cfbtn" class="cfbtn">리뷰</button>
				...
				<div class="registerbtn">
					<form action="/partner/register" method="get"> 
                       	<input type="submit" name="register" id="registerbtn" value="업체등록">
					 </form>
				</div>
                    <div class="paging">
                    	<%= pageNavi %>
